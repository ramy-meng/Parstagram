...
import com.codepath.rmeng.parstagram.MainActivity
import com.codepath.rmeng.parstagram.Post
import com.codepath.rmeng.parstagram.R
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.btnSave).setOnClickListener {
            ...
            if (photoFile != null) {
                ...
                Log.e(MainActivity.TAG, "The photo file is empty!")
                Toast.makeText(requireContext(), "The photo field is empty", Toast.LENGTH_SHORT).show()
            }
        }
